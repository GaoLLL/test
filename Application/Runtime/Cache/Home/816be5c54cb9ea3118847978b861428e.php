...
<div class="swiper-container view-img-list">
    ...
    <div class="swiper-wrapper">
        <?php if(is_array($imglist)): $i = 0; $__LIST__ = $imglist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="swiper-slide"><img src="<?php echo ($vo["img"]); ?>" class="view-list"></div><?php endforeach; endif; else: echo "" ;endif; ?>

      <!--<div class="swiper-slide"><img src="/files/images/header-img.png" class="view-list"></div>-->
    </div>
...
<div class="signing-info">
    <img src="<?php echo ($info["img"]); ?>" class="signing-view">
...
<div class="signing-list">
    <span>签署结束时间</span>
    <input type="datetime-local" class="signing-list-date" id="endtime">
</div>
<div class="signing-list">
    <span>是否自动流转</span>
    <p class="circulation">
        <a href="javascript:void(0)"  data-id="1"></a>
        <m>是</m>
        <a href="javascript:void(0)" class="circulation-cur" data-id="2"></a>
        <m>否</m>
    </p>
</div>
<div id="sss" style="display: none;">
    <div class="sign-seal sign-seal-cur">
		<div class="signature-class" style="position: inherit;">
			<a href="javascript:void(0)" class="signature-class-cur" id="oneclick" onClick="signOne()">签字</a>
			<a href="javascript:void(0)" onClick="signTwo()">印章</a>
		</div>
        <div class="tax-documents-search2" style="position: inherit;top: inherit;">
            <input type="text" placeholder="请输入搜索文件名称" id="signnamesearch">
            <a href="javascript:void(0)" onclick="getsignlist(this)" data-name="<?php echo ($first); ?>" data-status="remove" data-fid="0" class="tax-documents-search-btn">搜索</a>
        </div>
        <div class="institutional-hierarchy2" style="position: inherit;top: inherit;">
            <p id="topnav">
...
<!--        <div class="search-height4"></div> 显示 -->
    ...
    <div class="sign-seal">
		<div class="signature-class" style="position: inherit;">
			<a href="javascript:void(0)" id="oneclick" onClick="signOne()">签字</a>
			<a href="javascript:void(0)" class="signature-class-cur" onClick="signTwo()">印章</a>
		</div>
<!--        <div class="search-height" style="height: 14.18vw;"></div>-->
        <ul class="institutional-man" style="overflow: scroll; height: 40vh;">
            <?php if(is_array($seallist)): $i = 0; $__LIST__ = $seallist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <a class="background-none">
...
<div class="signing-choose">
    <a href="<?php echo U('Sendsign/templist',array('imgid'=>$id));?>" class="signing-list-a">
        <span>签署结束时间</span>
        <?php if(($minfo["id"]) == ""): ?><m>请选择模板</m>
            <?php else: ?>
            <m><?php echo ($minfo["name"]); ?></m><?php endif; ?>
    </a>
...
//            $(".layui-m-layer").find(".signature-class").children("a").each(function(i){
//                $(".layui-m-layer").find(".signature-class").children("a").eq(i).on("touchend",function(){
//                    alert(i);
//                   $(".layui-m-layer").find(".signature-class").children("a").removeClass("signature-class-cur");
//                    $(".layui-m-layer").find(".signature-class").children("a").eq(i).addClass("signature-class-cur");
//                    $(".layui-m-layer").find(".sign-seal").removeClass("sign-seal-cur");
//                    $(".layui-m-layer").find(".sign-seal").eq(i).addClass("sign-seal-cur");
//                    //getseallist();
//                })
//            })
...
/*
        function show(i){
            alert(i);
            $(".layui-m-layer").find(".signature-class a").removeClass("signature-class-cur");
            $(".layui-m-layer").find(".signature-class a").eq(i).addClass("signature-class-cur");
            $(".layui-m-layer").find(".sign-seal").removeClass("sign-seal-cur");
            $(".sign-seal").eq(i).addClass("sign-seal-cur");
            getseallist();
        }*/
		function signOne(){
			$(".layui-m-layer").find(".sign-seal").eq(1).removeClass("sign-seal-cur");
          	$(".layui-m-layer").find(".sign-seal").eq(0).addClass("sign-seal-cur");
			getseallist();
		}
		function signTwo(){
			$(".layui-m-layer").find(".sign-seal").eq(0).removeClass("sign-seal-cur");
          	$(".layui-m-layer").find(".sign-seal").eq(1).addClass("sign-seal-cur");
			getseallist();
		}
        ...
        function zztj(){
            ...
            if(posttype == 1){
                ...
                $.post('/home/sendsign/signdoing',{mid:mid,endtime:endtime,img:img,ismake:'1'},function(data){
                    if(data.code==1){
                        $(".spring-window").hide();
                        layer.open({
                            content: '发起签署成功'
                ...
                $.post('/home/sendsign/signdoing',{mid:mid,endtime:endtime,img:img,ismake:'2',tempatename:signname,templateson:arr},function(data){
                    if(data.code==1){
                        $(".spring-window").hide();
                        layer.open({
                            content: '发起签署成功'

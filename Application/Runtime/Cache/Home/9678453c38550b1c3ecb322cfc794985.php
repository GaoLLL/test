...
<div class="sign-document-class">
    <a href="<?php echo U('sendsign/zgysllist');?>" >已受理</a>
    <a href="<?php echo U('sendsign/zgywsllist');?>" class="sign-document-class-cur">未受理</a>
</div>
        ...
        layui.use('flow', function () {
            ...
            flow.load({
                ...
                , done: function (page, next) { //到达临界点（默认滚动触发），触发下一页
                    ...
                    $.get('/home/sendsign/getzgylist?page=' + page+'&type=2', function (res) {
                        if(res.code ==2){
                        ...
                        layui.each(res.data, function (index, item) {
                            if(item.isno == 0){
                                ...
                                var jj = '<p>拒绝理由:'+item.nodescript+'</p>';
                            }

                            lis.push('<li>' +
                                '        <a  href="/home/sendsign/zgysigndo/htid/'+item.id+'">' +

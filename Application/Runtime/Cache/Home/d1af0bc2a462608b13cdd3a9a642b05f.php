...
<div class="sign-document-class">
    ...
    <a href="<?php echo U('sendsign/mysignlist');?>" class="sign-document-class-cur">我发起</a>
    <a href="<?php echo U('sendsign/waitmysignlist');?>">我签署</a>
</div>
        ...
        layui.use('flow', function () {
            ...
            flow.load({
                ...
                , done: function (page, next) { //到达临界点（默认滚动触发），触发下一页
                    ...
                    $.get('/home/sendsign/getmysignlist?page=' + page, function (res) {
                        if(res.code ==2){

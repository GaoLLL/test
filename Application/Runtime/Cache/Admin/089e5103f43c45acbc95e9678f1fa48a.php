...
<form style="width:90%;text-align: center">
    <table>
        <tr>
            ...
            <td align="left"><input name="name"  class="input-text radius" placeholder="输入导航名称" value="<?php echo ($data["name"]); ?>" style="width:200px;height: 30px"></td>
        </tr>
        ...
        <tr>
            ...
            <td align="left">
                ...
                <img src="<?php echo ($data["img"]); ?>" id="show" width="100" height="50"><input type="button" id="uploadButton" value="上传图片" />
            </td>
        </tr>

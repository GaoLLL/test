...
<form style="width:90%;text-align: center">
    <table>
        ...
        <tr>
            ...
            <td align="left">
                <input name="title" value="<?php echo ($data["title"]); ?>" id="title" class="input-text radius" placeholder="公告名称" style="width:100%;height: 30px">
            </td>
        </tr>
        ...
        <!--<tr>
            ...
            <td align="left">
                <input type="hidden" name="img" id="imgs" value="<?php echo ($data["img"]); ?>"/>
                <div id="div_banner">
                    <img src="<?php echo ($data["img"]); ?>" id="show" width="100" height="50">
        ...
        <tr>
            ...
            <td align="left">
                <input type="text" id="sorts" name="sorts" value="<?php echo ($data["sorts"]); ?>" style="width:50px;height: 30px;line-height: 30px;text-align: center;" />
            </td>
        </tr>-->

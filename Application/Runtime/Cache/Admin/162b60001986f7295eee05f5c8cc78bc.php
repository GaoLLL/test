...
<div>
    ...
    <form action="/index.php/Admin/Swwscolumn/index">
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <?php if(empty($list)): ?><tr class="text-c va-m">
                        ...
                        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="text-c">
                                ...
                                <td class="text-l" style="cursor:pointer;"><?php echo ($vo["name"]); ?></td>
                                <td class="td-manage">
    ...
    $(document).ready(function () {
        ...
        $('.add').click(function () {
            var index = layer.open({
                ...
                area: ['700px', '470px'],
                fix: false, //不固定
                content: '/index.php/Admin/Swwscolumn/add',
                btn: ['确定', '关闭'],
                maxmin: true,
                yes: function () {
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Swwscolumn/add', form.serialize(), function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 2000,
                                end: function () {
        ...
        $('.save').click(function () {
            ...
            var index = layer.open({
                ...
                area: ['700px', '470px'],
                fix: false, //不固定
                content: '/index.php/Admin/Swwscolumn/save/id/' + id,
                btn: ['确定', '关闭'],
                maxmin: true,
                yes: function () {
                    var form = layer.getChildFrame('form', index);
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Swwscolumn/save', form.serialize(), function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 2000,
                                end: function () {
        ...
        $('.del').click(function () {
            ...
            var index = layer.msg('是否删除' + title + '? <br>删除后不可恢复，请谨慎操作！', {
                ...
                yes: function () {
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Swwscolumn/del', {id: id}, function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
        ...
        $('.alldel').click(function () {
            var index = layer.msg('是否确认删除' +  '? <br>删除后不可恢复，请谨慎操作！', {
                ...
                yes: function () {
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Swwscolumn/alldel', $('form').serialize() , function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 1000, end: function () {
                                    window.location.reload();
...
<script>
    $('.rbac').click(function () {
        ...
        layer.open({
            ...
            title: '管理员授权管理',
            area: ['100vw', '100vh'],
            content: '/index.php/Admin/Swwscolumn/rbac/id/' + id + '.html'
        })
    });
    $(function () {

...
<div>
    <nav class="breadcrumb">
        <i class="fa fa-list-ul"></i> 系统管理员权限组列表
    ...
    <form action="/index.php/Admin/Group/index">
    ...
    $(document).ready(function () {
        ...
        $('.add').click(function () {
            var index = layer.open({
                ...
                area: ['700px', '470px'],
                fix: false, //不固定
                content: '/index.php/Admin/Group/add',
                btn: ['确定', '关闭'],
                maxmin: true,
                yes: function () {
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Group/add', form.serialize(), function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 2000,
                                end: function () {
        ...
        $('.save').click(function () {
            ...
            var index = layer.open({
                ...
                area: ['700px', '470px'],
                fix: false, //不固定
                content: '/index.php/Admin/Group/save/id/' + id,
                btn: ['确定', '关闭'],
                maxmin: true,
                yes: function () {
                    var form = layer.getChildFrame('form', index);
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Group/save', form.serialize(), function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 2000,
                                end: function () {
        ...
        $('.del').click(function () {
            ...
            var index = layer.msg('是否删除' + title + '? <br>删除后不可恢复，请谨慎操作！', {
                ...
                yes: function () {
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Group/del', {id: id}, function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
        ...
        $('.alldel').click(function () {
            var index = layer.msg('是否确认删除' +  '? <br>删除后不可恢复，请谨慎操作！', {
                ...
                yes: function () {
                    ...
                    flag = 2;
                    $.post('/index.php/Admin/Group/alldel', $('form').serialize() , function (data) {
                        if (data.status == 1) {
                            layer.msg(data.msg, {
                                time: 1000, end: function () {
                                    window.location.reload();
...
<script>
    $('.rbac').click(function () {
        ...
        layer.open({
            ...
            title: '管理员授权管理',
            area: ['100vw', '100vh'],
            content: '/index.php/Admin/Group/rbac/id/' + id + '.html'
        })
    });
</script>